...
const EmployeeCreate = () => {
    ...
    const validateForm = () => {
        ...
        if (!stateUser.name.trim()) {
            newErrors.name = "Employee name cannot be blank";
        ...
        // Validate role
        if (!stateUser.role.trim() || !['admin', 'staff'].includes(stateUser.role)) {
        ...
        // Validate avatar
        if (!stateUser.avatar) {
            newErrors.avatar = "Please select employee avatar";
        }
                                            ...
                                            <div className="w-full px-4">
                                                <div className="relative w-full mb-10">
                                                    ...
                                                    <div className="relative">
                                                        <select
                                                            className={`w-full bg-transparent appearance-none placeholder:text-slate-400 outline-none text-slate-700 text-3xl border ${errors.role ? 'border-red-500' : 'border-slate-300 focus:border-cyan'
                                                                } rounded-md px-5 py-5`}
                                                    ...
                                                    {errors.role && (
                                                        <p className="text-red-500 text-2xl mt-2">{errors.role}</p>
                                                    )}
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="w-full px-4">
                                                <div className="relative w-full ">
                                                    ...
                                                    <input
                                                        ...
                                                        placeholder="Your employee confirm password"
                                            ...
                                            <div className="w-full">
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <input
                                                        ...
                                                        placeholder="Your employee phone number"
                                                        required
                                        ...
                                        <div className="w-full px-4">
                                            ...
                                            <div class="relative">
                                                ...
                                                <input
                                                    ...
                                                    placeholder="Your employee address"
