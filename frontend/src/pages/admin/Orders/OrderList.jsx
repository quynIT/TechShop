      ...
      <div className="p-10">
        <div class="relative overflow-hidden  text-gray-700 bg-clip-border">
          <div class=" items-center  justify-between gap-8 mb-8">
            <div>
              <h4 class="block font-sans text-4xl antialiased font-semibold leading-snug tracking-normal text-green">
                Invoice list
              </h4>
        ...
        {/* Table */}
        <div class="mt-6 px-0 ">
          <table class="w-full text-left border-2 shadow-md  table-fixed">
